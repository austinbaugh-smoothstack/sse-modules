...
public class LambdaSorting {
    ...
    private static void step1() {
        String[] strings = { "music", "eating", "something", "cats" };
    ...
    private static List<String> step2(List<Integer> numbers) {
        return numbers.stream().map(num -> (num % 2 == 0 ? "e" : "o") + num).collect(Collectors.toList());
    }
    ...
    public static void main(final String[] _args) {
        ...
        final List<String> strings = Arrays.asList("aaa", "baa", "abab", "bba", "aba", "bbbb");
